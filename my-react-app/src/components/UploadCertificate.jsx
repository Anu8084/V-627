...
const UploadCertificate = () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      const response = await fetch('https://v-627.onrender.com/api/student/upload-certificate', {
        method: 'POST',
        body: formData,
      });
  ...
  return (
    <div className="upload-form">
      <div className="form-header">
        <button className="back-btn" onClick={handleBack}>← Back to Certificates</button>
