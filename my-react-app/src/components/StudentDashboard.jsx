...
import certificateImage from '../assets/img/achievement.jpg';
import uploadImage from '../assets/img/upload.jpg';
import viewImage from '../assets/img/uploaded.jpg';
      ...
      {!showProfile && !showCertificatesMenu && (
        <div className="floating-buttons-container">
          ...
          <div className="menu-item">
            ...
            />
            <button 
              className="floating-btn certificates-btn" 
              onClick={() => setShowCertificatesMenu(true)}
            >
              My Certificates
            </button>
          </div>
        ...
        <div className="certificate-menu">
          <div className="menu-item">
            ...
            <button 
              ...
              onClick={() => navigate('/student/certificates/view')}
            >
          ...
          <div className="menu-item">
            ...
            <button 
              className="floating-btn" 
              onClick={() => navigate('/student/certificates/upload')}
            >
