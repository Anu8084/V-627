...
import technicalImg from '../assets/img/technical.jpg';
import nonTechnicalImg from '../assets/img/nontechnical.jpg';
      ...
      {!showTable ? (
        <div className="category-selection">
          <div className="category-item">
            <img src={technicalImg} alt="Technical" className="category-image" />
            <button 
          ...
          <div className="category-item">
            <img src={nonTechnicalImg} alt="Non-Technical" className="category-image" />
            <button 
